...
const envSchema = zod_1.z.object({
    ...
    DATABASE_URL: zod_1.z.string().default('postgresql://postgres:postgres@localhost:5432/tabproperty_erp?schema=public'),
    JWT_ACCESS_SECRET: zod_1.z.string().default('tabproperty_access_token_secret_key_2026_super_secure'),
    JWT_ACCESS_EXPIRES_IN: zod_1.z.string().default('7d'),
    JWT_REFRESH_SECRET: zod_1.z.string().default('tabproperty_refresh_token_secret_key_2026_super_secure'),
