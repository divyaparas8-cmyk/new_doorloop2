...
exports.cleanupUserByEmail = cleanupUserByEmail;
exports.purgeOrphanedUserByEmail = purgeOrphanedUserByEmail;
/**
 ...
 */
async function cleanupUserByEmail(db, email) {
    if (!email)
        return;
 ...
 */
async function purgeOrphanedUserByEmail(db, email) {
    if (!email)
        return;
    const cleanEmail = normalizeEmail(email);
